//
//  KakaoMapBaseViewController.swift
//  LetsBasketball
//
//  Created by 강석호 on 8/26/24.
//

import UIKit
import KakaoMapsSDK

class KakaoMapBaseViewController: UIViewController, MapControllerDelegate {
...
//        mapManager?.controller?.prepareEngine()
        ...
        mapContainer = mapManager?.container
