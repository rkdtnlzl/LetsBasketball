...
class TabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        nav2.tabBarItem = UITabBarItem(title: "관심 게시글", image: UIImage(systemName: "heart"), tag: 1)
        
        let profile = ProfileViewController()
        let nav3 = UINavigationController(rootViewController: profile)
        nav3.tabBarItem = UITabBarItem(title: "프로필", image: UIImage(systemName: "person"), tag: 2)
